...
class AddPet extends React.Component {
  ...
  async apiSavePet(customer) {
    return await API.post('Customers', '/items/customers', { body: customer });
  }
      ...
      <View style={{ flex: 1, paddingBottom: 0 }}>
        <ScrollView style={{ flex: 1 }}>
          ...
          <FormInput
            ...
            editable={true}
            placeholder="Please enter you customer's name"
            returnKeyType="next"
            ref="name"
          ...
          <FormInput
            ...
            underlineColorAndroid="transparent"
            editable={true}
            placeholder="Please enter your customer's breed"
            returnKeyType="next"
            ref="breed"
