...
class ViewPet extends React.PureComponent {
  static navigationOptions = ({ navigation, screenProps }) => console.log(screenProps) || ({
    title: `Viewing ${navigation.state.params.customer.name}`,
  })
  render() {
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          ...
          <View style={styles.infoContainer}>
            <Text style={styles.title}>{customer.name || 'No name'}</Text>
            <Text style={styles.info}>{customer.breed || 'No breed'}</Text>
            <Text style={styles.info}>{birthDay}</Text>
            <Text style={styles.info}>{customer.gender || 'No gender'}</Text>
          </View>
        </View>
